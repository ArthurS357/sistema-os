                ...
                <div className="p-4 bg-slate-50 border-t border-slate-200 flex flex-col gap-3">
                    ...
                    {editingId && (
                        <div className="flex gap-2 mt-1">
                            {/* Botão Abrir Arquivo Word */}
                            <button onClick={onOpenWord} className="flex-1 bg-slate-200 hover:bg-slate-300 text-slate-700 font-bold py-2 rounded-xl flex justify-center items-center gap-2">
                                <FileText size={18} /> Abrir Arquivo
                            </button>

                            {/* NOVO BOTÃO: Sincronizar Manualmente (Refresh) */}
                            <button
                                onClick={() => onSyncSingle(editingId)}
                                className="px-3 bg-amber-50 border border-amber-200 text-amber-700 hover:bg-amber-100 font-bold rounded-xl flex justify-center items-center gap-2"
                                title="Se você mudou o arquivo Word manualmente, clique aqui para atualizar o sistema."
                            >
                                <RefreshCw size={18} />
                            </button>
                        </div>
